        ...
        <div id='#advertisers' ref={target} className="bg-img">
            ...
            <div ref={addSec.ref} className="hero  add-box  mb-5">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <div>
                        <h1 className="text-5xl  font-bold text-warning text-white">Savespoints Network For Advertisers
                        </h1>
            ...
            <div ref={pubSec.ref}>
                <div className="hero  pub-box ">
                    <div className="hero-content flex-col lg:flex-row">
                        <div>
                            <h1 className="text-5xl font-bold text-white">Savespoints Network For Publishers</h1>
