                        ...
                        <div className=' md:flex md:justify-center md:items-center  footer-layout-sm'>
                            <div className=" md:flex md:items-center md:justify-center  ">
                                <div className='footer-text-container md:flex  md:flex-col md:items-start md:justify-center '>
                                    ...
                                    <p className='text-white text-justify'>Savespoints is an online marketing company focused on pay-for-performance online advertising campaigns. With over 25,000 publishers, Savespoints  generates millions of leads per year for its advertisers  from all over the world.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="footer-getintouch-container md:pt-4 p-2 ">
                                ...
                                <p className='text-white md:text-base text-xs'>Feel free to contact us regarding any concerns and our team will answer in a short time. We strive to provide the best support in the industry.</p>
                                <div>
                                    <div>
                                        <div className='md:flex md:justify-start md:items-start md:mt-4 flex mt-5'>
                                            <div className=' text-yellow-400 flex justify-start items-center'><MdLocationPin /> <span className='md:text-base text-xs'>16192 Coastal Highway
                                        ...
                                        <div className=' text-yellow-400 md:flex md:justify-start md:items-center flex mt-2'> <BsFillTelephoneFill /> <span className='md:text-base text-xs'>+1-202-555-0173</span> </div>
                                    </div>
